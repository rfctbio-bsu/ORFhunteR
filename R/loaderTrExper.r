...
#' @param f.TrExper character string giving the name of file with experimental
...
#' @param d.work character string giving the path to and name of work directory.
#'     Default value is NULL.
#' @return List of loaded transcript sequences.
#' @author Vasily V. Grinev
#' @examples
#' f.TrExper_path <- system.file("extdata",
...
loaderTrExper <- function(f.TrExper,
                          genome = "BSgenome.Hsapiens.UCSC.hg38",
                          d.work = NULL){
